...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	String pathValue = "?userId="+user.getId();
	%>
		...
		<div class="row">
			...
			<nav class="col-md-3 col-lg-2 bg-dark sidebar">
				<div class="position-sticky">
							<!-- Dashboard Button -->
                    <h3>
                        <button class="btn btn-link" type="button" onclick="<%="loadPage('dashboard.jsp"+pathValue+"')"%>" style="font-size: 90%;">DASHBOARD</button>
                    </h3>
					...
					<h3>
						<button class="btn btn-link collapsed" type="button"
							...
							aria-expanded="false" aria-controls="menu1">BOOKS</button>
					</h3>
					<div class="collapse" id="menu1">
						<ul class="nav flex-column">
							<li class="nav-item"><a onclick="<%="loadPage('viewBookForUser.jsp"+pathValue+"')"%>"
					...
					<h3>
						<button class="btn btn-link collapsed" type="button"
							...
							aria-expanded="false" aria-controls="menu2">CART</button>
					</h3>
					<div class="collapse" id="menu2">
						<ul class="nav flex-column">
							<li class="nav-item"><a onclick="<%="loadPage('viewCart.jsp"+pathValue+"')"%>"
								class="nav-link" href="#" name="user" value="<%=user.getId() %>">View Cart</a></li>
					...
					<h3>
						<button class="btn btn-link collapsed" type="button"
							...
							aria-expanded="false" aria-controls="menu3">ORDERS</button>
					</h3>
					<div class="collapse" id="menu3">
						<ul class="nav flex-column">
							<li class="nav-item"><a onclick="<%="loadPage('viewOrdersForUser.jsp"+pathValue+"')"%>"
								class="nav-link" href="#" name="user" value="<%=user.getId() %>">View Order</a></li>
