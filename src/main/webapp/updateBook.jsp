...
<body style="background-color: #c9d6c9">
	<div class="container">
		...
		<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4"
			style="color: white;">Update Book</p>


		<form class="addForm" action="updateBook" method="post">
			...
			<div class="d-flex flex-row align-items-center mb-4">
				...
				<div class="form-outline flex-fill mb-0">
					<input type="text" id="form3Example1c" class="form-control"
						name="title" value="<%=book.getTitle() %>" readonly />
			...
			<div class="d-flex flex-row align-items-center mb-4">
				...
				<div class="form-outline flex-fill mb-0">
					<input type="text" id="form3Example1c" class="form-control"
						name="author" value="<%=book.getAuthor() %>" readonly />
			...
			<div class="d-flex flex-row align-items-center mb-4">
				...
				<div class="form-outline flex-fill mb-0">
					<input type="text" id="form3Example1c" class="form-control"
						name="category" value="<%=book.getCategory() %>" readonly />
				</div>
			</div>
			...
			<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
				<button type="submit" class="btn btn-primary btn-lg" name="id" value="<%=bookId%>">Update</button>
			</div>
