...
<% List<User> users = ServiceFactory.getServiceFactory().getUserServiceImplementation().getAllUsers(); %>
<%
int totalusers = ServiceFactory.getServiceFactory().getUserServiceImplementation().getAllUsers().size();
%>
...
<body style="background-color: #c9d6c9">
    ...
    <div style="border: 1px solid grey; background-color: black; width: 99%; margin-top: .5%; margin-left: 0;">
        <h1 style='margin-top: 50px; text-align: center; color: white;'>User List</h1>
        <center>
            <table style="width: 90%; border: 4px solid white;">
               ...
               <%
				...
				%>
				<tr>
					<td colspan="4"><h3>No Users are Added</h3></td>
