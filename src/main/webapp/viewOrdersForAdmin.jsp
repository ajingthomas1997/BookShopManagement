...
<%List<Order> orders = ServiceFactory.getServiceFactory().getOrderServiceImplementation().getAllOrders();%>
<%
int totalBooks = ServiceFactory.getServiceFactory().getOrderServiceImplementation().getAllOrders().size();
%>
		...
		<center>
			<table style="width: 90%; border: 4px solid white;">
				...
				<tr>
					...
					<td><%=ServiceFactory.getServiceFactory().getUserServiceImplementation().getUserOrAdminById(orders.get(i).getUserId()).getName()%></td>
