<%@page import="com.agt.app.service.interfaces.UserService"%>
...
User user = ServiceFactory.getServiceFactory().getUserServiceImplementation().getUserById(id);
%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #c9d6c9">
	<div class="container">
		...
		<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4"
			style="color: white;">Update User</p>
			...
			<div class="d-flex flex-row align-items-center mb-4">
				...
				<div class="form-outline flex-fill mb-0">
					<input type="text" id="form3Example1c" class="form-control"
						name="name" placeholder="Your name" value="<%=user.getName()%>"
						readonly />
			...
			<div class="d-flex flex-row align-items-center mb-4">
				...
				<div class="form-outline flex-fill mb-0">
					<input type="date" id="form3Example1c" class="form-control"
						name="dob" placeholder="Date Of Birth" value="<%=user.getDob()%>"
						required />
