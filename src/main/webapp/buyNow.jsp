...
if(request.getParameter("cartId")!=null){
	cart = ServiceFactory.getServiceFactory().getOrderServiceImplementation().getCartItemByCartId(Integer.parseInt(request.getParameter("cartId")));	
}else{
...
<head>
<meta charset="UTF-8">
<title>Buy Now From Book List</title>
<link
