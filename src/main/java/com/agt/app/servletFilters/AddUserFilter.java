...
@WebFilter("/addUser") // Change to the actual URL pattern for your registration servlet
public class AddUserFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!isValid) {
			...
			request.getRequestDispatcher("addUser.jsp").forward(httpRequest, httpResponse);
		}
	}
